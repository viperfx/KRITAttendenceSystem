var Contacts = function() {
	...
	this.toJsonContactDTO = function(contact) {
		return {
			...
			|| (contact.OTHER_ADDRESS_SHELL.addressZip == undefined
					&& contact.OTHER_ADDRESS_SHELL.addressZip == null) ? null
			...
			|| (contact.DELIVERY_ADDRESS_SHELL.addressZip == undefined
					&& contact.DELIVERY_ADDRESS_SHELL.addressZip == null) ? null
